...
intersection_result_static_2 = Interval.intersection_static(interval1, interval3)
print("Intersection result (static method, no overlap):", intersection_result_static_2)  # None